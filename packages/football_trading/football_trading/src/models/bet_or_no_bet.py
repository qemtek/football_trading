...
from football_trading.src.utils.xgboost import get_team_model_performance, get_profit2
from football_trading.src.models.templates.base_model import upload_to_table
