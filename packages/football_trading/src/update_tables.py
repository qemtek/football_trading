...
from packages.football_trading.src.data_retrieval.load_fixture_list_from_FPL import get_fpl_fixtures
from packages.football_trading.src.data_retrieval.load_fixures_from_fbd import update_fixtures_from_fbd
from packages.football_trading.src.data_retrieval.create_team_fixtures_table import create_team_fixtures
from packages.football_trading.src.data_retrieval.load_manager_data_from_wiki import get_manager_data
from packages.football_trading.src.data_retrieval.load_player_data_from_FPL import get_player_data
from packages.football_trading.src.data_retrieval.load_PL_teams_from_wiki import get_teams_from_wiki
from packages.football_trading.src.data_retrieval.get_latest_fixtures_from_bfex import get_latest_fixtures
